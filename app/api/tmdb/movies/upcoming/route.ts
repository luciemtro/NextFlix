// api/tmdb/movies/upcoming/route.ts
// Cette route permet de récupérer les films qui arrivent prochainement.
...
export async function POST(req: Request) {
  try {
    ...
    console.log(`📡 Requête TMDB pour les films upcoming en ${language}...`);
